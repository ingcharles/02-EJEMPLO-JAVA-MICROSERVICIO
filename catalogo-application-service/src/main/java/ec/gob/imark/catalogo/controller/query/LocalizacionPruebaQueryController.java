...
public interface LocalizacionPruebaQueryController
{
	...
	*/
	...
	@ResponseStatus(HttpStatus.OK)
	@Operation(summary = "Método que obtiene los datos de la tabla localizacion_prueba")
	ResponseEntity<Page<LocalizacionPruebaResponseRecord>> findAllPaginateLocalizacionPrueba(
		@Valid @NotNull @RequestBody PaginationRequestRecord paginationRequestRecord);
