...
public interface LocalizacionJpaRepository extends JpaRepository<LocalizacionEntity, Integer>
{
	...
	*/
	@Query(value="SELECT new ec.gob.imark.catalogo.records.response.LocalizacionResponseRecord(t.idLocalizacion,t.nombreLocalizacion,t.codigoLocalizacion,t.idLocalizacionPadre,t.esUrbanaLocalizacion,t.nivelLocalizacion,t.nombreNacionalidadLocalizacion,t.regimenEscolarLocalizacion,t.tieneJuzgadoLocalizacion) FROM LocalizacionEntity t")
	...
	* @return List<LocalizacionResponseRecord>
	*/
	@Query(value="SELECT new ec.gob.imark.catalogo.records.response.LocalizacionResponseRecord(t.idLocalizacion,t.nombreLocalizacion,t.codigoLocalizacion,t.idLocalizacionPadre,t.esUrbanaLocalizacion,t.nivelLocalizacion,t.nombreNacionalidadLocalizacion,t.regimenEscolarLocalizacion,t.tieneJuzgadoLocalizacion) FROM LocalizacionEntity t WHERE t.idLocalizacion = :idLocalizacion")
