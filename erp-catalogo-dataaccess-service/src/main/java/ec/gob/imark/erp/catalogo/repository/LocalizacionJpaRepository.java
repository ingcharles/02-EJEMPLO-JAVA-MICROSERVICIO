...
public interface LocalizacionJpaRepository extends JpaRepository<LocalizacionEntity, Integer> {
  ...
  /*@Query(value = """
      ...
      """)*/
  @Query(value="SELECT new ec.gob.imark.erp.catalogo.records.response.LocalizacionResponseRecord(t.idLocalizacion, t.nombreLocalizacion) FROM LocalizacionEntity t WHERE t.nivelLocalizacion = :nivelLocalizacion") //, nativeQuery=true
